...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        ArrayList<QuestionJeu1> questionnaire = i.getParcelableArrayListExtra("questionnaire");
        ...
        QuestionnaireAdapter adapter = new QuestionnaireAdapter(this, questionnaire, reponses);
    ...
    public int compterBonnesReponses(ArrayList<QuestionJeu1> questionnaire, ArrayList<String> reponses){
        int compteur = 0;
