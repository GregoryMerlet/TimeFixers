...
public class QuestionJeu1 implements Parcelable {
    ...
    public QuestionJeu1(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    public static final Parcelable.Creator<QuestionJeu1> CREATOR = new Parcelable.Creator<QuestionJeu1>()
    {
        @Override
        public QuestionJeu1 createFromParcel(Parcel source)
        {
            return new QuestionJeu1(source);
        }

        @Override
        public QuestionJeu1[] newArray(int size)
        {
            return new QuestionJeu1[size];
        }
    };

    public static Parcelable.Creator<QuestionJeu1> getCreator()
    {
        return CREATOR;
    }
}
